 ...
 public class GameManager : MonoBehaviour
    {
        ...
        // Removed the invalid Start() declaration
        public static GameManager instance; // Singleton instance of the GameManager    public static GameManager instance; // Singleton instance of the GameManager
    ...
    public void StartGame()
        ...
        {
            if (playerStats != null && playerStats.CurrentHealth <= 0) // Check if player health is zero
            {
                isGameOver = true; // Set game over state to true
